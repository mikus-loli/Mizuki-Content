...
pinned: false
description: "一个功能强大的多平台音乐 API 服务，支持网易云音乐和 QQ 音乐，提供完整的 Cookie 管理、VIP 歌曲播放、自动续期及监控通知功能"
...
Meting-API 是一个开源的多平台音乐 API 服务，由 mikus-loli 开发维护。该项目 Fork 自 xizeyoupan/Meting-API，并在此之上做了大量功能增强与优化。它支持网易云音乐和 QQ 音乐两大主流音乐平台，提供了完整的 Cookie 管理系统、VIP 歌曲播放能力、自动续期机制以及完善的监测通知功能。
...
- **VIP 播放能力检测**：自动识别 Cookie 是否具有 VIP 权限
...
通知系统支持自定义消息格式和优先级设置，确保关键信息及时送达。
